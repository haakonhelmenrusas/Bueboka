  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textLine}>
        ...
        <Text style={styles.arrowCount}>{sumArrows(trainings, '7days')}</Text>
      </View>
      <View style={styles.textLine}>
        <Text style={styles.subtitle}>Denne måneden</Text>
        <Text style={styles.arrowCount}>{sumArrows(trainings, 'month')}</Text>
      </View>
      <View style={styles.textLine}>
        <Text style={styles.subtitle}>Totalt</Text>
        <Text style={styles.arrowCount}>{sumArrows(trainings)}</Text>
      </View>
    </View>
  );
}
